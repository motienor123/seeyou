      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-5">
        <div className="bg-white rounded-2xl border border-blue-100 p-5 space-y-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              {event.time && <p className="text-sm text-gray-500">{t.atTime(event.time)}</p>}
            </div>
          </div>
          ...
          {past && (
            <div className="flex items-center gap-2 mt-1 px-3 py-2 bg-green-50 rounded-xl">
              <span>✅</span>
              <p className="text-green-700 text-sm font-medium">{t.eventHappened}</p>
            </div>
          )}
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <div>
              <h2 className="font-bold text-gray-900 text-base">{t.snapsTitle}</h2>
              <p className="text-xs text-gray-400 mt-0.5">{t.snapsSubtitle}</p>
            </div>
            {!locked && (
              <>
                <button
          ...
          {locked ? (
            ...
            <div className="bg-white border border-dashed border-blue-200 rounded-2xl p-10 text-center">
              ...
              <p className="text-gray-500 text-sm">{t.noSnaps}</p>
