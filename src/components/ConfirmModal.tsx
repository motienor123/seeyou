    ...
    >
      ...
      >
        ...
        <div className="p-6">
          ...
          <h2 className="text-lg font-bold text-gray-900 text-center mb-1.5">{t.confirmTitle}</h2>
          <p className="text-sm text-gray-500 text-center leading-relaxed mb-1">{message}</p>
          <p className="text-xs text-gray-400 text-center mb-6">{t.confirmCannotUndo}</p>

          <div className="flex gap-3">
            <button
              onClick={onCancel}
              className="flex-1 py-2.5 border border-gray-200 rounded-xl text-sm font-semibold text-gray-600 hover:bg-gray-50 active:bg-gray-100 transition-colors"
            >
              {t.cancel}
            </button>
            <button
